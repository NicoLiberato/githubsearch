...
Run the script stand-alone ./gitsearch.py. Introduce the "topic" of the issues and the credentials of Github. 
...
#OBSERVATIONS
 ...
 In this case we are in the case of unauthenticated request. This can be modified in the code using the following request 
